            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
              <div className="container-fluid">
                ...
                <h1 style={{fontSize:'16px',
                            fontWeight:'bold',
                            fontFamily:'sans-serif'}} >Shaikh Developers</h1>
                </NavLink>
                <button
                ...
                >
                  <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                      ...
                      <h1 style={{fontSize:'16px',
                            fontWeight:'bold',
                            fontFamily:'sans-serif'}}> About</h1>
                      </NavLink>
                    </li>
                    <li className="nav-item">
                      ...
                      <h1 style={{fontSize:'16px',
                            fontWeight:'bold',
                            fontFamily:'sans-serif'}}> Services</h1>
                      </NavLink>
                    </li>
                    <li className="nav-item">
                      ...
                      <h1 style={{fontSize:'16px',
                            fontWeight:'bold',
                            fontFamily:'sans-serif'}}> Contact</h1>
                      </NavLink>
                    </li>
                   </ul>
                </div>
